import { pageNumber, resetBtn, startBtn } from '../others/renderHtml';
...
startBtn.addEventListener('click', async () => {
    ...
    cars.forEach((el) => {
        const ABtn = getButton(document.querySelectorAll('.car-start') as NodeListOf<HTMLButtonElement>, String(el.id));
